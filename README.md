...
Simply drag and drop the desired file into the application. [^1] [^2]
...
[^2]: Allows to load textures in any of the formats supported by [DevIL](http://openil.sourceforge.net/).
